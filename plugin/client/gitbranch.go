...
type ClientGitBranch interface {
	List(ctx context.Context, baseURL *duckv1.Addressable, id string, options ...OptionFunc) (*metav1alpha1.GitBranchList, error)
...
// List list branch
func (g *gitBranch) List(ctx context.Context, baseURL *duckv1.Addressable, id string, options ...OptionFunc) (*metav1alpha1.GitBranchList, error) {
	...
	uri := fmt.Sprintf("repositories/%s/branches", id)
...
func (g *gitBranch) Create(ctx context.Context, baseURL *duckv1.Addressable, payload metav1alpha1.CreateBranchPayload, options ...OptionFunc) (*metav1alpha1.GitBranch, error) {
	...
	uri := fmt.Sprintf("repositories/%s/branches", payload.Repository)
